...
`}function yt(e,t,s){const n={"index.html":{content:v["index.html"]},"src/App.tsx":{content:v["src/App.tsx"]},"src/Demo.tsx":{content:t},"src/main.tsx":{content:v["src/main.tsx"]},"src/styles/index.scss":{content:v["src/styles/index.scss"]},"src/styles/vendor/bootstrap.scss":{content:v["src/styles/vendor/bootstrap.scss"]},"src/styles/vendor/inula-ui.scss":{content:v["src/styles/vendor/inula-ui.scss"]},"package.json":{content:Se(e)},"tsconfig.json":{content:v["tsconfig.json"]},"vite.config.ts":{content:v["vite.config.ts"]},"sandbox.config.json":{content:at}};s&&(n["src/styles/index.scss"]={content:`${v["src/styles/index.scss"]}
${s}`});const o=qe({files:n}),r=document.createElement("form");r.method="POST",r.action="https://codesandbox.io/api/v1/sandboxes/define",r.target="_blank";const u=document.createElement("input");u.name="parameters",u.value=o;const p=document.createElement("input");p.name="query",p.value="module=/src/Demo.tsx",r.appendChild(u),r.appendChild(p),document.body.append(r),r.submit(),document.body.removeChild(r)}const wt=500,xt=20,Et=300,St="https://stackblitz.com",ve=["angular-cli","create-react-app","html","javascript","node","polymer","typescript","vue"],Ct=["project","search","ports","settings"],$t=["light","dark"],jt=["editor","preview"],_e={clickToLoad:e=>O("ctl",e),devToolsHeight:e=>ye("devtoolsheight",e),forceEmbedLayout:e=>O("embed",e),hideDevTools:e=>O("hidedevtools",e),hideExplorer:e=>O("hideExplorer",e),hideNavigation:e=>O("hideNavigation",e),openFile:e=>we("file",e),showSidebar:e=>kt("showSidebar",e),sidebarView:e=>re("sidebarView",e,Ct),startScript:e=>we("startScript",e),terminalHeight:e=>ye("terminalHeight",e),theme:e=>re("theme",e,$t),view:e=>re("view",e,jt),zenMode:e=>O("zenMode",e)};function Ce(e={}){const t=Object.entries(e).map(([s,n])=>n!=null&&_e.hasOwnProperty(s)?_e[s](n):"").filter(Boolean);return t.length?`?${t.join("&")}`:""}function O(e,t){return t===!0?`${e}=1`:""}function kt(e,t){return typeof t=="boolean"?`${e}=${t?"1":"0"}`:""}function ye(e,t){if(typeof t=="number"&&!Number.isNaN(t)){const s=Math.min(100,Math.max(0,t));return`${e}=${encodeURIComponent(Math.round(s))}`}return""}function re(e,t="",s=[]){return s.includes(t)?`${e}=${encodeURIComponent(t)}`:""}function we(e,t){return(Array.isArray(t)?t:[t]).filter(n=>typeof n=="string"&&n.trim()!=="").map(n=>`${e}=${encodeURIComponent(n)}`).join("&")}function $e(){return Math.random().toString(36).slice(2,6)+Math.random().toString(36).slice(2,6)}function ae(e,t){return`${je(t)}${e}${Ce(t)}`}function ce(e,t){const s={forceEmbedLayout:!0};return t&&typeof t=="object"&&Object.assign(s,t),`${je(s)}${e}${Ce(s)}`}function je(e={}){return(typeof e.origin=="string"?e.origin:St).replace(/\/$/,"")}function le(e,t,s){if(!t||!e||!e.parentNode)throw new Error("Invalid Element");e.id&&(t.id=e.id),e.className&&(t.className=e.className),It(t,s),e.replaceWith(t)}function de(e){if(typeof e=="string"){const t=document.getElementById(e);if(!t)throw new Error(`Could not find element with id '${e}'`);return t}else if(e instanceof HTMLElement)return e;throw new Error(`Invalid element: ${e}`)}function pe(e){return e&&e.newWindow===!1?"_self":"_blank"}function It(e,t={}){const s=Object.hasOwnProperty.call(t,"height")?`${t.height}`:`${Et}`,n=Object.hasOwnProperty.call(t,"width")?`${t.width}`:void 0;e.setAttribute("height",s),n?e.setAttribute("width",n):e.setAttribute("style","width:100%;")}class Dt{constructor(t){this.pending={},this.port=t,this.port.onmessage=this.messageListener.bind(this)}request({type:t,payload:s}){return new Promise((n,o)=>{const r=$e();this.pending[r]={resolve:n,reject:o},this.port.postMessage({type:t,payload:{...s,__reqid:r}})})}messageListener(t){var p;if(typeof((p=t.data.payload)==null?void 0:p.__reqid)!="string")return;const{type:s,payload:n}=t.data,{__reqid:o,__success:r,__error:u}=n;this.pending[o]&&(r?this.pending[o].resolve(this.cleanResult(n)):this.pending[o].reject(u?`${s}: ${u}`:s),delete this.pending[o])}cleanResult(t){const s={...t};return delete s.__reqid,delete s.__success,delete s.__error,Object.keys(s).length?s:null}}class Tt{constructor(t,s){this.editor={openFile:n=>this._rdc.request({type:"SDK_OPEN_FILE",payload:{path:n}}),setCurrentFile:n=>this._rdc.request({type:"SDK_SET_CURRENT_FILE",payload:{path:n}}),setTheme:n=>this._rdc.request({type:"SDK_SET_UI_THEME",payload:{theme:n}}),setView:n=>this._rdc.request({type:"SDK_SET_UI_VIEW",payload:{view:n}}),showSidebar:(n=!0)=>this._rdc.request({type:"SDK_TOGGLE_SIDEBAR",payload:{visible:n}})},this.preview={origin:"",getUrl:()=>this._rdc.request({type:"SDK_GET_PREVIEW_URL",payload:{}}).then(n=>(n==null?void 0:n.url)??null),setUrl:(n="/")=>{if(typeof n!="string"||!n.startsWith("/"))throw new Error(`Invalid argument: expected a path starting with '/', got '${n}'`);return this._rdc.request({type:"SDK_SET_PREVIEW_URL",payload:{path:n}})}},this._rdc=new Dt(t),Object.defineProperty(this.preview,"origin",{value:typeof s.previewOrigin=="string"?s.previewOrigin:null,writable:!1})}applyFsDiff(t){const s=n=>n!==null&&typeof n=="object";if(!s(t)||!s(t.create))throw new Error("Invalid diff object: expected diff.create to be an object.");if(!Array.isArray(t.destroy))throw new Error("Invalid diff object: expected diff.destroy to be an array.");return this._rdc.request({type:"SDK_APPLY_FS_DIFF",payload:t})}getDependencies(){return this._rdc.request({type:"SDK_GET_DEPS_SNAPSHOT",payload:{}})}getFsSnapshot(){return this._rdc.request({type:"SDK_GET_FS_SNAPSHOT",payload:{}})}}const ee=[];class Pt{constructor(t){this.id=$e(),this.element=t,this.pending=new Promise((s,n)=>{const o=({data:d,ports:m})=>{(d==null?void 0:d.action)==="SDK_INIT_SUCCESS"&&d.id===this.id&&(this.vm=new Tt(m[0],d.payload),s(this.vm),u())},r=()=>{var d;(d=this.element.contentWindow)==null||d.postMessage({action:"SDK_INIT",id:this.id},"*")};function u(){window.clearInterval(l),window.removeEventListener("message",o)}window.addEventListener("message",o),r();let p=0;const l=window.setInterval(()=>{if(this.vm){u();return}if(p>=xt){u(),n("Timeout: Unable to establish a connection with the StackBlitz VM"),ee.forEach((d,m)=>{d.id===this.id&&ee.splice(m,1)});return}p++,r()},wt)}),ee.push(this)}}const Lt=e=>{const t=e instanceof Element?"element":"id";return ee.find(s=>s[t]===e)??null};function Mt(e,t){const s=document.createElement("input");return s.type="hidden",s.name=e,s.value=t,s}function Rt(e){return e.replace(/\[/g,"%5B").replace(/\]/g,"%5D")}function ke({template:e,title:t,description:s,dependencies:n,files:o,settings:r}){if(!ve.includes(e)){const d=ve.map(m=>`'${m}'`).join(", ");console.warn(`Unsupported project.template: must be one of ${d}`)}const u=[],p=(d,m,j="")=>{u.push(Mt(d,typeof m=="string"?m:j))};p("project[title]",t),typeof s=="string"&&s.length>0&&p("project[description]",s),p("project[template]",e,"javascript"),n&&(e==="node"?console.warn("Invalid project.dependencies: dependencies must be provided as a 'package.json' file when using the 'node' template."):p("project[dependencies]",JSON.stringify(n))),r&&p("project[settings]",JSON.stringify(r)),Object.entries(o).forEach(([d,m])=>{p(`project[files][${Rt(d)}]`,m)});const l=document.createElement("form");return l.method="POST",l.setAttribute("style","display:none!important;"),l.append(...u),l}function At(e,t){const s=ke(e);return s.action=ce("/run",t),s.id="sb_run",`<!doctype html>
<html>
...
</html>`}function Nt(e,t){const s=ke(e);s.action=ae("/run",t),s.target=pe(t),document.body.appendChild(s),s.submit(),document.body.removeChild(s)}function te(e){return e!=null&&e.contentWindow?(Lt(e)??new Pt(e)).pending:Promise.reject("Provided element is not an iframe.")}function zt(e,t){Nt(e,t)}function Ot(e,t){const s=ae(`/edit/${e}`,t),n=pe(t);window.open(s,n)}function Ht(e,t){const s=ae(`/github/${e}`,t),n=pe(t);window.open(s,n)}function Ut(e,t,s){var u;const n=de(e),o=At(t,s),r=document.createElement("iframe");return le(n,r,s),(u=r.contentDocument)==null||u.write(o),te(r)}function Bt(e,t,s){const n=de(e),o=document.createElement("iframe");return o.src=ce(`/edit/${t}`,s),le(n,o,s),te(o)}function Wt(e,t,s){const n=de(e),o=document.createElement("iframe");return o.src=ce(`/github/${t}`,s),le(n,o,s),te(o)}const Vt={connect:te,embedGithubProject:Wt,embedProject:Ut,embedProjectId:Bt,openGithubProject:Ht,openProject:zt,openProjectId:Ot};function Ft(e,t,s){const n={"index.html":v["index.html"],"src/App.tsx":v["src/App.tsx"],"src/Demo.tsx":t,"src/main.tsx":v["src/main.tsx"],"src/styles/index.scss":v["src/styles/index.scss"],"src/styles/vendor/bootstrap.scss":v["src/styles/vendor/bootstrap.scss"],"src/styles/vendor/inula-ui.scss":v["src/styles/vendor/inula-ui.scss"],"package.json":Se(e),"tsconfig.json":v["tsconfig.json"],"vite.config.ts":v["vite.config.ts"]};s&&(n["src/styles/index.scss"]=`${v["src/styles/index.scss"]}
${s}`),Vt.openProject({title:e,description:"Demo of Inula UI",template:"node",files:n},{openFile:"Demo.tsx"})}function Qt(e){const{id:t,renderer:s,title:n,description:o,tsxSource:r,scssSource:u}=e,p=F(K(o)),l=K(r),d=u?K(u):void 0,m=xe.useIntl(),j=c.useRef(null),P=F(String.raw`
${"```tsx"}
${l}
${"```"}
`),D=d?F(String.raw`
